...
int main(int argc, char *argv[], char *envp[]) {
	...
	if(init_tfp0() == KERN_SUCCESS) {
		...
		// kcall8 works
		kret = kcall8(ksym(KSYMBOL_RET_300), 0xdeadbeef41424340, 0xdeadbeef41424341, 0xdeadbeef41424342, 0xdeadbeef41424343, 0xdeadbeef41424344, 0xdeadbeef41424345, 0xdeadbeef41424346, 0xdeadbeef41424347);
		printf("kcall8 KSYMBOL_RET_300 kret = 0x%llx\n", kret);

		// kcall8(0xcafebabe41424344, 0xdeadbeef41424340, 0xdeadbeef41424341, 0xdeadbeef41424342, 0xdeadbeef41424343, 0xdeadbeef41424344, 0xdeadbeef41424345, 0xdeadbeef41424346, 0xdeadbeef41424347);

		// khexdump(kgad(KGADGET_PROLOGUE), 0x100);
#if 0
		// 1.
